...
* Files in Git can reside in three main states: committed, modified and staged.  </span>.
    ...
    <span style="color:#0099ff"> * Saving Changes : All files in a checked out (or working) copy of a project file are either in a tracked or untracked state. </span>.
